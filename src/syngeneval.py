...
printHeader("Evaluating the Results of Synonym Generation")

# Only proceed if formatted input data exists
exitIfFileNotExist(inputFileGenerationEvaluation)

generated = readCSV(inputFileGenerationEvaluation).reset_index(drop = True)
generated[contentColumn] = generated[hpoidColumn] + " " + generated[contentColumn]

gold = readCSV(inputFileGenerationEvaluationGold).reset_index(drop = True)
...
plt.legend(loc="center left", bbox_to_anchor=(1, 0.5))
plt.savefig(outputFileGenerationCumulativeRecallPrecision, dpi=300, bbox_inches="tight")
...
plt.legend(loc="center left", bbox_to_anchor=(1, 0.5))
plt.savefig(outputFileGenerationRecallPrecisionF1Appearance, dpi=300, bbox_inches="tight")
...
plt.legend(loc="center left", bbox_to_anchor=(1, 0.5))
plt.savefig(outputFileGenerationCumulativeRecallPrecisionTotal, dpi=300, bbox_inches="tight")
...
axs[0][0].set_title("Precision")
axs[0][1].set_title("Recall")
axs[1][0].set_title("Synonym Count")
axs[1][1].set_title("F1-Score")

plt.legend(loc="center left", bbox_to_anchor=(1, 0.5))
plt.savefig(outputFileGenerationRecallPrecisionF1AppearanceTotal, dpi=300, bbox_inches="tight")
